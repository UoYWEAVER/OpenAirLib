...
var krpanoplugin = function()
{
	...
	console.log("Videoplayer plugin");
	...
	local.registerplugin = function(krpanointerface, pluginpath, pluginobject)
	{
		...
		// actions
		plugin.registerattribute("playvideo",   interface_playvideo);
		...
		// global export
		kglobs.krp = {};
		kglobs.krp.video = video;
		kglobs.krp.krpano = krpano;
		kglobs.krp.plugin = plugin;
		kglobs.krp.ready = false;
	...
	function interface_playvideo(vurl)
	{
	  video.pause();
	  video.src = vurl;
		video.play();
	...
	function playvideo( vurl ) {
	  if ( video ) {
	    ...
	    video = plugin.videoDOM;
	    if( video === kglobs.krp.video )
	    	console.log("pi:playvideo video element mismatch");
	    else
	    	console.log("pi:playvideo video element match");
